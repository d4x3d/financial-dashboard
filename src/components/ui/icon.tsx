...
// Create a mapping of icon names to their SVG paths
const iconPaths: Record<string, string> = {
  // Add only the icons we actually use
  'home': 'M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z',
  'dashboard': 'M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z',
  'transfer': 'M8 11h3v10h2V11h3l-4-4-4 4zM4 3v2h16V3H4z',
  'transaction': 'M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 9h-2V8h2v4zm0 4h-2v-2h2v2zm-8-4h4V8H4v4zm8 0h4V8h-4v4zm4 4h-4v-2h4v2zm0-8V5h-4v2h4zm-8-2v2H4V5h4zm-4 10h4v-2H4v2z',
